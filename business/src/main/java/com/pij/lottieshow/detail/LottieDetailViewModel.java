...
public class LottieDetailViewModel {
    ...
    public LottieDetailViewModel(@NonNull Iterable<LottieSource> sources, @NonNull LottieSink sink) {
        this.sink = sink;
    ...
    @SuppressWarnings("WeakerAccess")
    public void loadLottie(URI newFile) {
